...
test("array literal syntax and indexing", function() {
    ...
    equal('cellar door', favouriteThings[0], 'cellar door');
    equal(42, favouriteThings[1], 42);
    equal(true, favouriteThings[2], true);
});

test("array type", function() {
    equal('object', typeof([]), 'object');
});

test("length", function() {
    var collection = ['a','b','c'];
    equal(3, collection.length, 3);
});
